      ...
      <List>
        {popularPosts.map(({ node: popularPost }) => (
          <ListItem key={popularPost.id}>
            <StyledLink to={`/${popularPost.frontmatter.locale}${popularPost.fields.slug}`}>
              <PostTitle>{popularPost.frontmatter.title}</PostTitle>
              <StyledPostDate date={popularPost.frontmatter.date} localDate={popularPost.frontmatter.localDate} />
            </StyledLink>
          </ListItem>
        ))}
      </List>
